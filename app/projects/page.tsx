                        ...
                        {projectGalleryFiles.map((file) => {
                          ...
                          return (
                            <button
                              ...
                              className="group overflow-hidden rounded-[24px] border bg-white text-left shadow-sm transition hover:border-blue-200 hover:shadow-md"
                            >
                              <div className="relative aspect-[4/3] overflow-hidden bg-slate-100">
                                ...
                                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-950/85 via-slate-950/45 to-transparent p-4 text-white">
                                  <div className="text-sm font-semibold">{file.topic || "Fotografie k projektu"}</div>
                                  <div className="mt-1 line-clamp-2 text-xs text-slate-100/90">
                              ...
                              <div className="border-t px-4 py-3">
                                <div className="flex items-center justify-between gap-3">
                                  <span className="rounded-full bg-slate-100 px-2.5 py-1 text-[11px] font-semibold text-slate-700">{projectFileCategoryLabel[file.category]}</span>
                                  <span className="text-[11px] text-slate-500">{fmtDateTime(file.created_at)}</span>
                                </div>
                              </div>
                            </button>
                          );
